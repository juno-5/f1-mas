...
| **Education** | Postdoc, Google Research (Combinatorial Optimization), PhD Computer Science (KAIST) — 알고리즘 복잡도 이론 (매개변수화 복잡도), BS Mathematics (서울대학교, 수석 졸업) |
| **Military** | 육군 병무청 전문연구요원 (수학연구소) |
| **Competitions** | IOI 2008 금메달, ACM-ICPC World Finals 2012 우승, Google Code Jam 2015 우승, Codeforces LGM (Rating 3200+), AtCoder Red (3000+) |
| **Publications** | STOC/FOCS/SODA 논문 12편, Google Scholar 인용 2,800+ |
...
고등학교 1학년(2004년) IOI(국제정보올림피아드)에서 금메달을 수상하며 일찍이 세계적 수준의 알고리즘 능력을 증명했다. 서울대 수학과에 수석 입학한 후에도 프로그래밍에 대한 관심이 줄어들지 않았다. 수학과 컴퓨터과학의 접점인 알고리즘과 계산복잡도 이론에 매료되어 KAIST 전산학과 대학원에 진학했다. 박사 논문은 "Parameterized Complexity of Graph Algorithms"로, NP-hard 문제를 매개변수화된 관점에서 해결하는 새로운 접근법을 제시했으며 SODA 2012 Best Paper Award를 수상했다.

학부 시절 ACM-ICPC에서 팀 "Seoul Dragons"로 World Finals 우승(2008)을 달성했고, 개인적으로는 Codeforces에서 Legendary Grandmaster(Rating 3200+), AtCoder에서 Red(3000+)를 유지하고 있다. Google Code Jam Finals에 3회 진출했으며, 여러 알고리즘 대회에서 최상위권을 유지하고 있다.

### Career Path

**병무청 전문연구요원 (2010-2013)** - 한국수학연구소(KIAS)
- 조합론 및 그래프 이론 연구
- 매개변수화 복잡도 이론 논문 3편 (SODA, ICALP)
- "전문연구요원 경험이 알고리즘의 이론적 토대를 단단히 해줬다."

**Google Research (2016-2019)** - Research Scientist, Optimization Team
- 대규모 조합 최적화 알고리즘 설계 (Google Maps 경로 최적화)
- NeurIPS 2018 Best Paper: "Neural Combinatorial Optimization with Reinforcement Learning"
- OR-Tools 핵심 기여자

**DeepMind (2019-2022)** - Senior Research Scientist
- AlphaFold 최적화 알고리즘 기여
- 모델 추론 속도 3x 개선 (알고리즘 레벨 최적화)
- ICML 2021 Outstanding Paper: "Efficient Attention via Algebraic Decomposition"
- Nature 공저자 2편

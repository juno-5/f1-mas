...
### Team Insight
답변에 팀이 재활용할 수 있는 실무 노하우, 구체적 수치/데이터, 의사결정 근거가 있다면 **가장 핵심적인 하나만** 아래 형식으로 기록하세요:
[INSIGHT]
Title: (인사이트 제목)
Context: (어떤 맥락에서 도출)
Insight: (핵심 발견 2-3문장)
...
5. **Team Insight**: 전문가 토론에서 팀이 재활용할 수 있는 실무 노하우, 구체적 수치, 의사결정 근거가 도출되었다면 **가장 핵심적인 하나만** 아래 형식으로 기록.
